...
function extractReleaseNotes(changelogFile, prerelease) {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const fileStream = fs_1.default.createReadStream(changelogFile, { encoding });
        ...
        try {
            for (var _d = true, rl_1 = __asyncValues(rl), rl_1_1; rl_1_1 = yield rl_1.next(), _a = rl_1_1.done, !_a;) {
                ...
                try {
                    const line = _c;
                    const start_of_release = !!line.match('^#+ \\[[0-9]') ||
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const packageFilesPathString = core.getInput('changelog-files-config');
            const packageVersionsString = core.getInput('released-package-versions');
            ...
            for (const packageWithVersion of Object.entries(packageVersions)) {
                const releaseNotes = extractReleaseNotes(packageFilesPath[packageWithVersion[0]], 'false');
                const md = `
...
const remove = __nccwpck_require__(3620);
...
const gfm = __nccwpck_require__(5772);
const parse = __nccwpck_require__(4859);
const stringify = __nccwpck_require__(7114);
const unified = __nccwpck_require__(5075);

const { collectDefinitions, removeDefinitions } = __nccwpck_require__(7983);
const createSlackifyOptions = __nccwpck_require__(9308);
...
const defaultHandlers = __nccwpck_require__(3769);
const phrasing = __nccwpck_require__(7489);

const { wrap, isURL, isPotentiallyEncoded } = __nccwpck_require__(494);
